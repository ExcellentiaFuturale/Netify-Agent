...
typedef enum {
    ...
    ND_RISK_MALWARE_HOST_CONTACTED = 54,
...
const nd_risks_t nd_risks = {
    ...
    { ND_RISK_TLS_NO_ALPN, "No TLS ALPN Found" },
...
const nd_ndpi_risk_t nd_ndpi_risks = {
    ...
    { NDPI_FULLY_ENCRYPTED, ND_RISK_FULLY_ENCRYPTED },
    ...
    { NDPI_MALWARE_HOST_CONTACTED, ND_RISK_MALWARE_HOST_CONTACTED },
    ...
    { NDPI_TLS_ALPN_SNI_MISMATCH, ND_RISK_TLS_ALPN_SNI_MISMATCH },
    ...
    { NDPI_TLS_NOT_CARRYING_HTTPS, ND_RISK_TLS_NO_ALPN },
