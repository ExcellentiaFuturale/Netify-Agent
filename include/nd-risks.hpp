...
typedef enum {
    ...
    ND_RISK_FULLY_ENCRYPTED                       = 52,
    ND_RISK_TLS_ALPN_SNI_MISMATCH                 = 53,
...
const nd_risks_t nd_risks = {
    ...
    { ND_RISK_FULLY_ENCRYPTED, "Fully Encrypted Flow" },
    ...
    { ND_RISK_NUMERIC_IP_HOST, "Numeric IP Address" },
    ...
    { ND_RISK_TLS_MISSING_SNI,
      "TLS SNI Extension Not Found" },
    { ND_RISK_TLS_NOT_CARRYING_HTTPS,
      "TLS not carrying TLS" },
    ...
    { ND_RISK_UNIDIRECTIONAL_TRAFFIC,
...
const nd_ndpi_risk_t nd_ndpi_risks = {
    ...
    { NDPI_NUMERIC_IP_HOST, ND_RISK_NUMERIC_IP_HOST },
