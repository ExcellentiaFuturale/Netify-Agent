...
typedef enum {
    ...
    ND_PROTO_IEC60870_5_104 = 277,  // Extension for industrial 104 protocol
    // recognition
...
const nd_ndpi_proto_t nd_ndpi_protos = {
    ...
    { NDPI_PROTOCOL_APACHE_THRIFT, ND_PROTO_APACHE_THRIFT },
    ...
    { NDPI_PROTOCOL_HTTP2, ND_PROTO_HTTP2 },
    ...
    { NDPI_PROTOCOL_SERVICE_LOCATION, ND_PROTO_SLP },
