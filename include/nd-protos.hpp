...
typedef enum {
  ...
  ND_PROTO_DEPR137 =
      137,  // Deprecated: Generic (old category matching)
  ...
  ND_PROTO_DOH = 243,
  ND_PROTO_DTLS = 244,
  ND_PROTO_GOOGLE_MEET_DUO =
      245,  // TODO: Implement in Agent.
  ...
  ND_PROTO_IEC60870_5_104 =
      277,  // Extension for industrial 104 protocol
            // recognition
  ...
  ND_PROTO_SOAP = 283,
  ND_PROTO_TARGUS_GETDATA =
      284,               // Targus Dataspeed (speedtest).
  ...
  ND_PROTO_HOTS = 317,           // Heroes of the Storm
  ND_PROTO_BACNET = 318,         // BACnet
...
const nd_protos_t nd_protos = {
    ...
    {ND_PROTO_SOURCE_ENGINE, "SourceEngine"},
...
typedef unordered_map<uint16_t, nd_proto_id_t>
    nd_ndpi_proto_t;
...
const nd_ndpi_proto_t nd_ndpi_protos = {
    ...
    {NDPI_PROTOCOL_BACNET, ND_PROTO_BACNET},
    ...
    {NDPI_PROTOCOL_OICQ, ND_PROTO_OICQ},
    ...
    {NDPI_PROTOCOL_SKYPE_TEAMS_CALL,
     ND_PROTO_SKYPE_TEAMS_CALL},
    ...
    {NDPI_PROTOCOL_SOURCE_ENGINE, ND_PROTO_SOURCE_ENGINE},
    {NDPI_PROTOCOL_SPOTIFY, ND_PROTO_SPOTIFY},
    {NDPI_PROTOCOL_SRTP, ND_PROTO_SRTP},
    ...
    {NDPI_PROTOCOL_WORLDOFWARCRAFT,
     ND_PROTO_WORLDOFWARCRAFT},
    {NDPI_PROTOCOL_WORLD_OF_KUNG_FU,
     ND_PROTO_WORLDOFKUNGFU},
...
typedef unordered_map<uint16_t,
                      vector<pair<uint16_t, nd_proto_id_t>>>
    nd_ndpi_portmap_t;
